...
# Ensure 'final_df' is initialized in session state
if 'final_df' not in st.session_state:
    st.session_state.final_df = pd.DataFrame()  # or whatever initial value you want
...
df['start_date'] = df['start_date'].apply(safe_to_datetime)
